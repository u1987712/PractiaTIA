...
public class GameManager : MonoBehaviour {
    ...
    public int spawnMaskLayerIndex = 1; // �ndice del layer que marca zona de spawn
    ...
    Vector3 GetValidSpawnPosition() {
        ...
        do {
            ...
            // Posici�n aleatoria sobre el terrain
            ...
            // Comprobar si la m�scara (Layer 1) domina la posici�n
            ...
            if (textureValue < 0.5f) valid = false; // si la m�scara no domina --> no spawn
        ...
        if (!valid) return Vector3.zero; // si no encontr� posici�n v�lida
        return pos;
    }
    ...
    public void ObjectDroppedCorrectly(GameObject obj, float bonusTime) {
        if (spawnedObjects.Contains(obj)) {
            ...
            Debug.Log("Objeto depositado correctamente. Tiempo a�adido: " + bonusTime);
        }
    }
    ...
    {
        Debug.Log("BOTÓN DE BEACON PULSADO");
        ActivateBeacons();
    }
